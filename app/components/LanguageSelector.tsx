...
const LanguageSelector = () => {
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute top-full right-0 mt-1 w-32 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[9999]" style={{position: 'absolute'}}>
